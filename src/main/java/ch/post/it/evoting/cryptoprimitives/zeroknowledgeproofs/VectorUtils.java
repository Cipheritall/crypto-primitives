...
class VectorUtils {
	 ...
	 */
	static GroupVector<ZqElement, ZqGroup> vectorAddition(final GroupVector<ZqElement, ZqGroup> first, final GroupVector<ZqElement, ZqGroup> second) {
		checkNotNull(first);
		checkNotNull(second);
	 ...
	 * @return a new {@link GroupVector} which is the result of {@code first} * {@code second}.
	 */
	static GroupVector<GqElement, GqGroup> vectorMultiplication(final GroupVector<GqElement, GqGroup> first,
	 ...
	 */
	static GroupVector<GqElement, GqGroup> vectorExponentiation(final GroupVector<GqElement, GqGroup> vector, final ZqElement exponent) {
		checkNotNull(vector);
	 ...
	 */
	static GroupVector<ZqElement, ZqGroup> vectorScalarMultiplication(final ZqElement scalar, final GroupVector<ZqElement, ZqGroup> vector) {
		checkNotNull(vector);
		checkNotNull(scalar);
