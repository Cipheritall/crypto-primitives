...
public interface CryptoPrimitiveService {
	 ...
	 * @return A random Base32-encoded string of {@code length} characters. Must in range (0, 1000).
	 */
	 ...
	 *
	 * @param length l, the length of the string to be generated, in number of chars.
	 * @return A random Base64-encoded string of {@code length} characters. Must in range (0, 1000).
	 */
