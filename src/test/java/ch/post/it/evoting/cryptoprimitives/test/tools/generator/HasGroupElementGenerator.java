...
public class HasGroupElementGenerator {

	/**
	 * Generate a list of {@link HasGroup} elements.
	 *
	 ...
	 */
	public static <E extends HasGroup<G>, G extends MathematicalGroup<G>> List<E> generateElementList(final int numElements, Supplier<E> s) {
		return Stream.generate(s).limit(numElements).collect(Collectors.toList());
	}

	/**
	 * Generate a matrix of {@link HasGroup} elements.
	 *
	 ...
	 */
	public static <E extends HasGroup<G>, G extends MathematicalGroup<G>>
